...
# -- Helper to reset summary state if inputs or options change
def reset_summary():
...
st.markdown('<small>Note: Summary length is approximate and depends on the input text and method.</small>', unsafe_allow_html=True)

# Detect change of input type or method or summary length or pdf format and reset summary if changed
if (
